    ...
    for epoch in range(args.num_epochs):
        ...
        if args.gradient_accumulation:
            ...
            for iter in tqdm(range(0, n_iters)):
                ...
                logits_cur = retain_outputs_current.logits
                logits_ref = retain_outputs_original.logits

                # labels: [B, T], -100은 ignore
                labels = retain_batch["labels"]

                # log-prob / prob
                log_p = F.log_softmax(logits_cur, dim=-1)
